...
expect class CryptoEngine {
    ...
    fun generateAuthHash(password: String, salt: String, iterations: Int = 4, memory: Int = 98304, parallelism: Int = 4): String
    fun generateVaultKey(): String
    fun deriveKek(password: String, encryptionSalt: String, iterations: Int = 4, memory: Int = 98304, parallelism: Int = 4): ByteArray
